...
# **Топология**
![The topology shows PC-A connecting to Switch S1 via the console port and F0/6 port.](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.001.png)
# **Таблица адресации**
...
![](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.002.png)
...
![](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.003.png)
...
![](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.004.png)
...
C:\> **ping 192.168.1.10** ![Изображение выглядит как текст

Автоматически созданное описание](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.005.png)

1. Из командной строки компьютера PC-A отправьте эхо-запрос на административный адрес интерфейса SVI коммутатора S1.

C:\> **ping 192.168.1.2![Изображение выглядит как текст

Автоматически созданное описание](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.006.png)**
...
1. Чтобы завершить сеанс Telnet, введите **exit**. ![Изображение выглядит как текст

Автоматически созданное описание](Aspose.Words.3cb17923-b8a7-4672-8d07-97d04bed0b72.007.png)
